...
public class RandomDataUtil {
	...
	public static String getRandomURL() {
		return "http://" + getRandomAlphaString(3) + "." + getRandomAlphaString(10) + ".com/" + getRandomAlphaString(getRandomInt(3,10));
	}

	public static String getRandomTestEmail() {
		return RandomDataUtil.getRandomAlphaString(10) + "@" + RandomDataUtil.getRandomAlphaString(3) + ".wordniktesting.com";
	}
